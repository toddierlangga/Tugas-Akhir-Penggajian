                        ...
                        <div class="row">
                            <div class="col-md-5 col-md-offset-1">
                                <div class="social text-center">
                                    ...
                                    <h4> Individual Designer Register </h4>
                                </div>
                                @if(count($errors) > 0)
                                ...
                                <form class="form" method="POST" action="{{route('register')}}">
                                    ...
                                    <div class="card-content">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" placeholder="Nama Designer">
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="material-icons">home</i>
                                            </span>
                                            <input type="text" name="alamat" class="form-control" placeholder="Alamat Designer">
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="material-icons">call</i>
                                            </span>
                                            <input type="text" name="telp" class="form-control" placeholder="Telp Designer">
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="material-icons">subject</i>
                                            </span>
                                            <input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi Designer">
                                        </div>
                                        <hr>
                                        <div class="input-group">
                                            <span class="input-group-addon">
