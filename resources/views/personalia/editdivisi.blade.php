...
<div class="col-md-12">
    <div class="col-md-12">
        <div class="card">
            <form method="POST" action="{{route('update_divisi', $data->id_divisi)}}" class="form-horizontal">
                ...
                <div class="card-content">
                    <div class="row">
                        <label class="col-sm-2 label-on-left">Nama Divisi</label>
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty">
                                <label class="control-label"></label>
                                <input type="text" name="nama_divisi" class="form-control"
                                    placeholder="Nama Divisi" value="{{ $data->nama_divisi }}">
                            </div>
                        </div>
                    </div>
                    <hr>
